      ...
      <div className="center-section">
        <div className="row-one-dash">
          <div className="box-dash bible-box-dash" onClick={this.submitHandler}>
            {/* <div id="biblia"></div> */}
            <h3>{lessonTitle ? lessonTitle.lesson_title : "Make Disciple Makers"}</h3>
            {eventId ? events.map((event, i) => {
        ...
        <p>[2] and what you have heard from me in the presence of many witnesses entrust to faithful men, who will be able to teach others also.(ESV) </p>
      </div>
            )}
